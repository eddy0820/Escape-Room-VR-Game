...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public abstract class ContinuousMovementBase : LocomotionProvider
    {
        /// <summary>
        ...
        protected virtual Vector3 ComputeDesiredMove(Vector2 input)
        {
            ...
            var translationInRigSpace = forwardRotation * inputMove * (m_MoveSpeed * Time.unscaledDeltaTime);
        ...
        protected virtual void MoveRig(Vector3 translationInWorldSpace)
        {
            ...
            if (m_CharacterController != null && m_CharacterController.enabled)
            {
                ...
                {
                    m_VerticalVelocity += Physics.gravity * Time.unscaledDeltaTime;
                }

                motion += m_VerticalVelocity * Time.unscaledDeltaTime;
